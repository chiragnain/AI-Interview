...
function Feedback({params}) {
  ...
  return (
    <div className='p-10'>
      ...
      <h2 className='text-primary text-lg my-3'>Your overall intervew rating: <strong>7/10</strong></h2>
      ...
      {feedbackList&&feedbackList.map((item,index)=>(
        ...
        <CollapsibleTrigger className='flex justify-between p-2 bg-secondary rounded-lg my-2 w-full gap-10 text-left'>
